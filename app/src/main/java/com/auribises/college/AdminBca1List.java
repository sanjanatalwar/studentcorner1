...
public class AdminBca1List extends AppCompatActivity implements AdapterView.OnItemClickListener {

    ListView listView;
    EditText editTextSearch;
    ArrayList<StudentBca1> studentList;
    AdminBca1Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_bca1_list);
        init();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Util.RETERIEVE_STUDENT_PHP, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    adapter = new AdminBca1Adapter(AdminBca1List.this, R.layout.adminbca1list_item, studentList);
                    listView.setAdapter(adapter);
                    listView.setOnItemClickListener(AdminBca1List.this);

                } catch (Exception e) {
                    e.printStackTrace();
                    Log.i("test", e.toString());
                    Toast.makeText(AdminBca1List.this, "One Some Exception" + e.toString(), Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(AdminBca1List.this, "Two Some Error", Toast.LENGTH_LONG).show();
            }
        });
    ...
    void deleteStudent(){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Delete "+ studentBca1.getStuName());
    ...
    void deleteFromCloud(){
        //progressDialog.show();
        StringRequest request = new StringRequest(Request.Method.POST, Util.BCA_ONE_DELETE_PHP, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try{
                    ...
                    if(success == 1){
                        studentList.remove(pos);
                        adapter.notifyDataSetChanged();
                        Toast.makeText(AdminBca1List.this,message,Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(AdminBca1List.this,message,Toast.LENGTH_LONG).show();
                    }
                    ...
                    e.printStackTrace();
                    //progressDialog.dismiss();
                    Toast.makeText(AdminBca1List.this,"Some Exception",Toast.LENGTH_LONG).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                //progressDialog.dismiss();
                Toast.makeText(AdminBca1List.this,"Some Volley Error: "+error.getMessage(),Toast.LENGTH_LONG).show();
            }
        })
        {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("id",String.valueOf(studentBca1.getId()));
                return map;
            }
        };
