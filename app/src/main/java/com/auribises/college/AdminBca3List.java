...
public class AdminBca3List extends AppCompatActivity implements AdapterView.OnItemClickListener{

        ListView listView;
        EditText editTextSearch;
        ArrayList<StudentBca3> studentList;
        AdminBca3Adapter adapter;
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_bca3_list);
    init();
    ...
    void retrieveFromCloud() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Util.RETERIEVE_BCA3_PHP, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        studentList.add(new StudentBca3(id, n, p, e, a, g, c, "", mm, cm, pm, d, 0, pass));
                        Log.i("test", studentList.toString());
                    }

                    adapter = new AdminBca3Adapter(AdminBca3List.this, R.layout.adminbca3list_item, studentList);
                    listView.setAdapter(adapter);
                    listView.setOnItemClickListener(AdminBca3List.this);

                } catch (Exception e) {
                    e.printStackTrace();
                    Log.i("test", e.toString());
                    Toast.makeText(AdminBca3List.this, "One Some Exception" + e.toString(), Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(AdminBca3List.this, "Two Some Error", Toast.LENGTH_LONG).show();
            }
        });
    ...
    void deleteStudent(){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Delete "+ studentBca3.getStuName());
    ...
    void deleteFromCloud(){
        //progressDialog.show();
        StringRequest request = new StringRequest(Request.Method.POST, Util.BCA_THREE_DELETE_PHP, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try{
                    ...
                    if(success == 1){
                        studentList.remove(pos);
                        adapter.notifyDataSetChanged();
                        Toast.makeText(AdminBca3List.this,message,Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(AdminBca3List.this,message,Toast.LENGTH_LONG).show();
                    }
                    ...
                    e.printStackTrace();
                    //progressDialog.dismiss();
                    Toast.makeText(AdminBca3List.this,"Some Exception",Toast.LENGTH_LONG).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                //progressDialog.dismiss();
                Toast.makeText(AdminBca3List.this,"Some Volley Error: "+error.getMessage(),Toast.LENGTH_LONG).show();
            }
        })
        {
            @Override
